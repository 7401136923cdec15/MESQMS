 ...
 * 退料数据结构
 */
public class APSMaterialReturn implements Serializable {
	...
	public APSMaterialReturn() {
	}

	public APSMaterialReturn(MSSBOMItem wBOMItem, int wLineID, int wProductID, int wCustomerID, int wOrderID,
