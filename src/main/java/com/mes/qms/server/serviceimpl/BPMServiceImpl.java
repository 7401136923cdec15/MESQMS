...
public class BPMServiceImpl implements BPMService {
	...
	public ServiceResult<Boolean> BPM_MsgUpdate(BMSEmployee wLoginUser, int wTaskID, int wLocalScope,
		...
		try {
			...
			// 通知人
//			if (wAPIResult.getReturnObject().containsKey("Recipients")) {
//				wNotifyUserIDList.addAll(
//						StringUtils.parseIntList(wAPIResult.getReturnObject().get("Recipients").toString().split(",")));
//
//				wNotifyUserIDList = wNotifyUserIDList.stream().distinct().collect(Collectors.toList());
//			}
